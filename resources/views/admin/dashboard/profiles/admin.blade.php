        ...
        <div class="user-about-block m-0">
            <div class="row">
                    ...
                    <div class="change-profile text-center">
                        <div class="dropdown w-auto d-inline-block">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <input wire:click="updatePhoto({{$user->id}})" type="button" id="updatePhotoBtn" class="d-none"/>
                                <input wire:click="removePhoto({{$user->id}})" type="button" id="removePhotoBtn" class="d-none"/>
                ...
                <div class="col-md-8 mt-md-4">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="#!" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-user mr-2 f-18"></i>{{$user->dni}}</a>
                            ...
                            <div class="clearfix"></div>
                            <a href="#!" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-phone mr-2 f-18"></i>{{$user->phone}}</a>
                        </div>
                    ...
                    <ul class="nav nav-tabs profile-tabs nav-fill" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="feather icon-user mr-2"></i>Perfil</a>
                        </li>
            ...
            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="card">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        ...
                        <button wire:click="edit({{$user->id}})" type="button" class="btn btn-primary btn-sm rounded m-0 float-right" data-toggle="collapse" data-target=".pro-dont-edit" aria-expanded="false" aria-controls="pro-dont-edit-1 pro-dont-edit-2">
                ...
                <div class="card">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        ...
                        <button wire:click="edit({{$user->id}})" type="button" class="btn btn-primary btn-sm rounded m-0 float-right" data-toggle="collapse" data-target=".pass-dont-edit" aria-expanded="false" aria-controls="pro-dont-edit-1 pro-dont-edit-3">
                            <i class="feather icon-edit"></i>
                        </button>
                    </div>
